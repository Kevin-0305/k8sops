...
var apis = []model.SysApi{
	...
	{global.GVA_MODEL{ID: 86, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/monitorServer/createServer", "添加服务器", "monitorServer", "POST"},
	{global.GVA_MODEL{ID: 87, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/monitorServer/getServerList/:page/:pageSize/", "获取服务器列表", "monitorServer", "GET"},
	{global.GVA_MODEL{ID: 88, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/monitorServer/putServerInfo/:id/", "批量删除api", "monitorServer", "PUT"},
	{global.GVA_MODEL{ID: 89, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/monitorServer/getServerInfo/:id/", "批量删除api", "monitorServer", "GET"},
	{global.GVA_MODEL{ID: 90, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "/monitorServer/deleteServer/:id/", "批量删除api", "monitorServer", "DELETE"},
}
