    ...
    "paths": {
        ...
        "/monitorServer/createServer": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "公网IP，私网IP，IPV6，ssh端口，主机名，分组id，状态服务器类型，系统",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.MonitorServer"
                        }
                    }
                ],
                "responses": {
        ...
        "/monitorServer/getServerInfo/{id}/": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/monitorServer/getServerList/{page}/{pageSize}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/monitorServer/putServerInfo/{id}/": {
            "put": {
                "produces": [
                    "application/json"
                ],
